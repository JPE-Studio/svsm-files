...
className={"w-body"}>
<Box
className={"w-box w-page-wrapper-5"}>
<Slot>
<Fragment_1>
<Box
tag={"nav"}
...
<Box
tag={"section"}
className={"w-box w-hero-1"}>
<Box
className={"w-box w-hero-image-wrapper-1"}>
<Image
src={baseURL_1+"assets/"+CMS_1?.data?.data?.[0]?.titelbild}
width={1440}
height={651}
className={"w-image w-image-15"} />
</Box>
</Box>
<Box
tag={"section"}
className={"w-box w-section-2"}>
<Box
className={"w-box w-container-20"}>
<Box
className={"w-box w-box-25"}>
<Heading
className={"w-heading w-heading-35"}>
{CMS_1?.data?.data?.[0]?.headline}
</Heading>
<Text
className={"w-text"}>
{CMS_1?.data?.data?.[0]?.autor}
</Text>
</Box>
<HtmlEmbed
code={CMS_1?.data?.data?.[0]?.body}
className={"w-html-embed w-image-19"}>
</HtmlEmbed>
</Box>
</Box>
<Box
tag={"section"}
className={"w-box w-section-neuigkeiten-2"}>
<Slot>
<Fragment_1>
<Box
tag={"div"}
...
{komponentenCMS?.data?.data?.["neuigkeiten_section_button_text"]}
</Link>
</Box>
<Box
