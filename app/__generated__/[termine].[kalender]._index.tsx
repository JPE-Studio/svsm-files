/* eslint-disable */
      ...
      import { Fragment as Fragment_1, Box as Box, Text as Text, Image as Image, Separator as Separator, HtmlEmbed as HtmlEmbed, Slot as Slot, Button as Button, Heading as Heading, Paragraph as Paragraph, Time as Time } from "@webstudio-is/sdk-components-react";
...
className={"w-body"}>
<Box
className={"w-box w-page-wrapper-2"}>
<Slot>
<Fragment_1>
<Box
tag={"nav"}
...
<Box
tag={"section"}
className={"w-box w-termine"}>
<Box
className={"w-box w-container-22"}>
<Box
className={"w-box w-content-top-2"}>
<Box
className={"w-box"}>
<Heading
tag={"h2"}
className={"w-heading w-heading-36"}>
...
<Box
className={"w-box w-3-col-grid-2"}>
{CMS_1?.data?.data?.map((CollectionItem: any, index: number) =>
<Fragment key={index}>
<Box
className={"w-box w-card-3"}>
<Image
src={"https://cms.svsm.at/"+"assets/"+CollectionItem?.titelbild}
className={"w-image w-card-image-3"} />
<Box
className={"w-box w-heading-37"}>
<Box
className={"w-box w-label-wrapper-1"}>
{(CollectionItem?.sektion==1) &&
<Link
className={"w-link w-link-90"}>
<Text
tag={"span"}
className={"w-text w-text-83"}>
{"Laufen"}
</Text>
</Link>
}
...
<Link
className={"w-link w-link-91"}>
<Text
tag={"span"}
className={"w-text w-text-84"}>
{"Bewegung"}
</Text>
</Link>
}
...
<Link
className={"w-link w-link-92"}>
<Text
tag={"span"}
className={"w-text w-text-85"}>
{"Reisen/Kultur"}
</Text>
</Link>
}
...
<Link
className={"w-link w-link-93"}>
<Text
tag={"span"}
className={"w-text w-text-86"}>
{"Tischtennis"}
</Text>
</Link>
}
...
<Link
className={"w-link w-link-94"}>
<Text
tag={"span"}
className={"w-text w-text-87"}>
{"Fußball"}
</Text>
</Link>
}
...
<Link
className={"w-link w-link-95"}>
<Text
tag={"span"}
className={"w-text w-text-88"}>
{"Velo"}
</Text>
</Link>
}
...
<Box
className={"w-box w-date-wrapper-2"}>
<Slot>
<Fragment_1>
<HtmlEmbed
...
<Box
className={"w-box w-body-7"}>
<Heading
tag={"h3"}
className={"w-heading w-heading-38"}>
{CollectionItem?.titel}
</Heading>
<Paragraph
className={"w-paragraph w-paragraph-15"}>
