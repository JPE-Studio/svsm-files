/* eslint-disable */
      ...
      import { Fragment as Fragment_1, Box as Box, Text as Text, Image as Image, Separator as Separator, HtmlEmbed as HtmlEmbed, Slot as Slot, Heading as Heading, Paragraph as Paragraph, Button as Button, Bold as Bold } from "@webstudio-is/sdk-components-react";
...
let ueberunsCMS = useResource("ueberunsCMS_1")
...
className={"w-body"}>
<Box
className={"w-box w-page-wrapper-4"}>
<Slot>
<Fragment_1>
<Box
tag={"nav"}
...
<Box
tag={"section"}
className={"w-box w-über-uns-2"}>
<Box
className={"w-box w-container-12"}>
<Box
className={"w-box w-2col-grid-6"}>
<Box
className={"w-box w-col-7"}>
<Box
className={"w-box"}>
<Heading
tag={"h2"}
className={"w-heading w-heading-28"}>
{ueberunsCMS?.data?.data?.headline1}
</Heading>
<Paragraph
className={"w-paragraph"}>
{ueberunsCMS?.data?.data?.body1}
</Paragraph>
</Box>
</Box>
<Box
className={"w-box"}>
<Image
src={baseURL_1+"assets/"+ueberunsCMS?.data?.data?.bild1}
className={"w-image w-image-13"} />
</Box>
</Box>
</Box>
</Box>
<Box
tag={"section"}
className={"w-box w-über-uns-3"}>
<Box
className={"w-box w-container-13"}>
<Box
className={"w-box w-2col-grid-7"}>
<Box
className={"w-box"}>
<Image
src={baseURL_1+"assets/"+ueberunsCMS?.data?.data?.bild2}
className={"w-image w-image-14"} />
</Box>
<Box
className={"w-box w-col-8"}>
<Box
className={"w-box"}>
<Heading
tag={"h2"}
className={"w-heading w-heading-29"}>
{"Über die Sportvereinigung Sozialministerium"}
</Heading>
<Paragraph
className={"w-paragraph"}>
{"Die Sportvereinigung Sozialministerium (SVSM) wurde 1956 gegründet und ist seitdem eine Plattform für Sport und Kultur. Neben den traditionellen Sektionen wie Fußball und Bewegung bietet die SVSM heute auch moderne Angebote wie die Sektion Velo. Unser vielfältiges Kulturprogramm umfasst Ausflüge, Stadtspaziergänge und die jährliche SVSM-Reise – stets mit dem Ziel, Gemeinschaft und Ausgleich zu fördern."}
</Paragraph>
</Box>
</Box>
</Box>
...
{(ueberunsCMS?.data?.data?.["faq_visable"]) &&
<Box
tag={"section"}
className={"w-box w-faq-1"}>
<Slot>
<Fragment_1>
<Box
tag={"div"}
...
{(ueberunsCMS?.data?.data?.["cta_visable"]) &&
<Box
tag={"section"}
className={"w-box w-cta-3"}>
<Slot>
<Fragment_1>
<Box
tag={"div"}
...
<Image
src={baseURL_2+"assets/"+CMS_1?.data?.data?.["logo_footer"]}
width={50}
height={72}
className={"w-image"} />
<Box
