/* eslint-disable */
      ...
      import { Fragment as Fragment_1, Box as Box, Text as Text, Image as Image, Separator as Separator, HtmlEmbed as HtmlEmbed, Button as Button, Slot as Slot } from "@webstudio-is/sdk-components-react";
...
<Box
tag={"section"}
className={"w-box w-section-4"}>
<Box
className={"w-box w-container-26"}>
<HtmlEmbed
code={CMS_1?.data?.data?.impressum}
className={"w-html-embed"}>
</HtmlEmbed>
</Box>
</Box>
